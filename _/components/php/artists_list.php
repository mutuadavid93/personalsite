    ...
    <div class="row" id="artistsindex">
        <section class="scrollspy clearfix col-lg-3 hidden-sm">
            <ul class="nav nav-list affix">
                ...
                <li><a href="#Etyan_Kizito"><span class="glyphicon glyphicon-user"></span> Etyan Kizito</a></li>
                <li><a href="#David_Mutua"><span class="glyphicon glyphicon-user"></span> David Mutua</a></li>
            </ul>
        </section>
        ...
        <section class="col-lg-9">
            ...
            <?php require_once 'Etyan_Kizito.php'; ?>
            <?php require_once 'David_Mutua.php'; ?>
        </section>
    </div>
</section>
